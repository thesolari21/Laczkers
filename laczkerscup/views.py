...
from .views_losowanie import losowanie_formularz, losowanie_wyniki, losowanie_lista, losowanie_importuj, losowanie_etapy_json
from .views_szwajcar import szwajcar_formularz, szwajcar_usun_kolejke, szwajcar_importuj
